...
def main():
    ...
    A('<div class="authors">[Author name]</div>')
    A('<div class="affil">[Affiliation]. Correspondence: [email]</div>')
    ...
    A('<div class="decl">')
    A('<p><b>Ethical approval.</b> <span class="todo">[To be completed. This analysis used data '
      'collected routinely by participants\' own devices and uploaded to personal Nightscout '
      'instances. The basis on which these data were accessed and the consent position must be '
      'stated here before circulation.]</span></p>')
    ...
    A('<p><b>Funding.</b> <span class="todo">[None declared / to be completed.]</span></p>')
    A('<p><b>Competing interests.</b> <span class="todo">[To be completed. The author contributes '
      'to one of the delivery systems analysed.]</span></p>')
